...
<div class="container d-md-flex d-lg-flex my-3">
    ...
    <div class=" d-none d-md-block  d-lg-block col-sm-12 col-md-8 ">
        <img src="https://cdn.pixabay.com/photo/2016/12/03/18/57/car-1880381__340.jpg" class="w-100  " style="  height: 500px;
   ...
   <div class="mb-3">
        ...
        <div class="mb-3">
                <?php
                        ...
                        if(isset($_SESSION['l_msg']) && $_SESSION['l_msg']!=''):
         ?>
                <div class="alert alert-danger" role="alert">
                      <?=$_SESSION['l_msg']?>          
</div>
         <?php
                            unset($_SESSION['l_msg']);
                        endif;
       ...
       <div class="mb-3 col-sm-11" style="width:90%;">
        ...
        <div class="mb-3">
            <a href="<?=base_url('Register')?>" class="nav-link text-center">Don't Have An Account &rarr;</a>
        </div>
    </div>
   </form>
